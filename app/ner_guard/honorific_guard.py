...
# 인간 호칭 allowlist (앞 단어가 이거면 PASS) — 역할/직책/관계 명사가 정당하게 '님'을 취함.
# 실DB 오탐(회원/배우자/수상 등) 반영해 확장(2026-06-05). 누락 시 검수 red queue 노이즈.
HUMAN_TITLES = frozenset(
    "수석 책임 매니저 선생 고객 기사 팀장 사장 사용자 부장 차장 과장 대리 주임 실장 "
    "이사 상무 전무 부회장 대표 원장 교수 담당자 관리자 상담원 센터장 단장 사모 "
    "형 누나 오빠 언니 어머 아버 어머니 아버지 할머니 할아버지 따님 아드 "
    # 역할/직책 확장
    "회원 배우자 수상 의원 위원 위원장 회장 총장 학생 환자 의사 간호사 변호사 박사 "
    "검사 판사 강사 교사 코치 감독 점장 본부장 지점장 직원 사원 동료 선배 후배 손님 "
    "회계사 세무사 변리사 약사 작가 "
    # 가족/관계
    "부모 자녀 아들 딸 며느리 사위 처남 매형 신랑 신부 사돈 이모 고모 삼촌".split()
)
